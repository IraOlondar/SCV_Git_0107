...
## О GIT
Git эта одна из систем контроля версий нашего проекта, то есть система, записывающая изменения в файл или набор файлов в течение времени и позволяющая вернуться позже к определённой версии.
...
vodeo.mp4
```
При том файлы в проекте можно продолжать использовать.
